...
<div class="hero">
    <div class="container hero-center">
        <h1 class="title hide-mobile"><img src="/img/tramlines-text.png" /><br/><span style="color: #ed1c24; font-size: 1.4em;">Tramlines Festival Schedule Planner</span></h1>
        ...
        <h2>Signing up takes just <span class="tram-red">30 seconds</span></h2>
        <p>It's literally so we know who's schedule is who's - we'll never email you! Just click on one of the options below to get started:</p>
